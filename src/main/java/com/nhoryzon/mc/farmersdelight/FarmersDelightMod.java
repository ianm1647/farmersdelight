...
public class FarmersDelightMod implements ModInitializer {
    ...
    protected void registerBiomeModifications() {
        ...
        BiomeModifications.addFeature(context -> BiomeSelectors.includeByKey(BiomeKeys.SWAMP, BiomeKeys.MANGROVE_SWAMP, BiomeKeys.JUNGLE, BiomeKeys.BAMBOO_JUNGLE, BiomeKeys.SPARSE_JUNGLE).test(context),
    ...
    protected void registerLootTable() {
        ...
        LootTableEvents.MODIFY.register((resourceManager, manager, id, supplier, setter) -> {
            ...
            if (scavengingEntityIdList.contains(id)) {
                supplier.pool(LootPool.builder().with(LootTableEntry.builder(injectId)).build());
            }
            ...
            if (villageHouseChestsId.contains(id)) {
                supplier.pool(LootPool.builder().with(LootTableEntry.builder(injectId).weight(1).quality(0)).build());
            }
    ...
    protected void registerVillagerTradeOffer() {
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 1,
                factories -> factories.add(((entity, random) -> new TradeOffer(new ItemStack(ItemsRegistry.ONION.get(), 26),
                        new ItemStack(Items.EMERALD), 16, 2, .05f))));
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 1,
                factories -> factories.add(((entity, random) -> new TradeOffer(new ItemStack(ItemsRegistry.TOMATO.get(), 26),
                        new ItemStack(Items.EMERALD), 16, 2, .05f))));
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 2,
                factories -> factories.add(((entity, random) -> new TradeOffer(new ItemStack(ItemsRegistry.CABBAGE.get(), 16),
                        new ItemStack(Items.EMERALD), 16, 5, .05f))));
        TradeOfferHelper.registerVillagerOffers(VillagerProfession.FARMER, 2,
                factories -> factories.add(((entity, random) -> new TradeOffer(new ItemStack(ItemsRegistry.RICE.get(), 20),
                        new ItemStack(Items.EMERALD), 16, 5, .05f))));
