...
public class DecompositionRecipeCategory implements DisplayCategory<DecompositionRecipeDisplay> {
    ...
    public Text getTitle() {
        return (Text) FarmersDelightMod.i18n("jei.decomposition");
    }
    ...
    public List<Widget> setupDisplay(DecompositionRecipeDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createLabel(new Point(bgBounds.x + 33, bgBounds.y + 30), Text.literal("  "))
                .noShadow().leftAligned().tooltip(Text.of(FarmersDelightMod.i18n("jei.decomposition.light").getString())));
        widgets.add(Widgets.createLabel(new Point(bgBounds.x + 46, bgBounds.y + 30), Text.literal("  "))
                .noShadow().leftAligned().tooltip(Text.of(FarmersDelightMod.i18n("jei.decomposition.fluid").getString())));
        widgets.add(Widgets.createLabel(new Point(bgBounds.x + 59, bgBounds.y + 30), Text.literal("  "))
                .noShadow().leftAligned().tooltip(Text.of(FarmersDelightMod.i18n("jei.decomposition.accelerators").getString())));
